...
if __name__ == "__main__":
    ...
    allbaseFiles = glob.glob('/s/' + socket.gethostname()+'/a/nobackup/galileo/stip-images/'+ args.album + '/Sentinel-2/**/raw/' + '*-0.tif', recursive=True)
    print('All files: ', len(allbaseFiles))
    # print(allbaseFiles)
    # image = [0,1,2,3]
    #
